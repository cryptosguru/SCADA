        ...
        ByteBuffer* writeBuffer)
{
    ...
    numberOfItems = LinkedList_size(itemIds);
    ...
    item = LinkedList_getNext(itemIds);
    ...
    for (i = 0; i < numberOfItems; i++) {
        ...
        value = (MmsValue*) valueElement->data;
        ...
        LinkedList values, ByteBuffer* writeBuffer)
{
    ...
    numberOfItems = LinkedList_size(values);
        ...
        ByteBuffer* writeBuffer)
{
    ...
    variableIdentifier = createNewDomainVariableSpecification(domainId, itemId);
