        ...
        ByteBuffer* payload, uint32_t connectTimeoutInMs)
{
    ...
    timeout = Hal_getTimeInMs() + CONFIG_TCP_READ_TIMEOUT_MS;
    ...
    presentationBuffer = &sPresentationBuffer;
...
IsoClientConnection_sendMessage(IsoClientConnection self, ByteBuffer* payloadBuffer)
{
    ...
    presentationBuffer = &presentationBCMemory;
    ...
    sessionBuffer = &sessionBufferBCMemory;
