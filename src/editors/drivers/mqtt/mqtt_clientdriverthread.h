 ...
 *
 */
#ifndef MQTT_CLIENT_DRIVERTHREAD
#define MQTT_CLIENT_DRIVERTHREAD
...
class MQTT_CLIENT_DRV MQTT_client_DriverThread : public DriverThread 
{
	public:
	...
	MQTT_client_DriverThread(DriverInstance *parent) : 
		DriverThread(parent),h_pipe(NULL), nIndex(1), pipe_sends_cont(0),
        msg_id(0), Done(false), restart_count(0)
	{ 
		IT_IT("MQTT_client_DriverThread::MQTT_client_DriverThread");

		instanceID = ((MQTT_client_Instance*)Parent)->instanceID;
...
#endif //MQTT_CLIENT_DRIVERTHREAD