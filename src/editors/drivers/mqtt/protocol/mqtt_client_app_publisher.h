 ...
 *
 */
#ifndef MQTT_CLIENT_PUBLISHER
#define MQTT_CLIENT_PUBLISHER
...
#ifdef USE_RIPC_MIDDLEWARE
////////Middleware/////////////
typedef class MQTT_client_imp_publisher* par;
...
class MQTT_client_imp_publisher
{
	public:
	 MQTT_client_imp_publisher(char* broker_host_name, char* line_number);
	~MQTT_client_imp_publisher();
	 ...
	 void monitoring_dir_consumer(struct iec_item *p_item);
};

#endif //MQTT_CLIENT_PUBLISHER